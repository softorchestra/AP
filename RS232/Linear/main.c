...
/*========================================================
** Rest_3P_CalibrationData
** Reset 3 points calibration data
** Author: Chang-Hsieh Wu
** Date  : 04/01/04
==========================================================*/
void Rest_3P_CalibrationData(void)
{
    FILE *f;
...
main(int argc, char *argv[])
{
    ...
    if (argc < 3)
    {
        g_print("\n");
        g_print("**************** Usage: **************************\n");
        g_print("** Linear232 /dev/ttySx  n                      **\n");
        g_print("** x=0, 1, 2...n    0=COM1, 1=COM2, ...etc      **\n");
        g_print("** n=5, 9  5=5 points, 9= 9 points calibration  **\n");
        g_print("**************************************************\n");
        return -1;
    }
